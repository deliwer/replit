...
import { DirhemFormatter } from "@/lib/currency";
import { generateQuoteMessage, openWhatsApp } from "@/lib/whatsapp";
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">{DirhemFormatter.format(valuation.marketValue)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Trade-in Rate (50%):</span>
                      <span className="font-semibold">{DirhemFormatter.format(valuation.tradeValue)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">AquaCafe Bonus (20%):</span>
                      <span className="font-semibold text-dirham-green">{DirhemFormatter.format(valuation.bonusValue)}</span>
                    </div>
                    <Separator />
                    <div className="flex justify-between text-lg">
                      <span className="font-semibold">Total Value:</span>
                      <span className="font-bold text-aqua-primary text-xl">{DirhemFormatter.format(valuation.totalValue)}</span>
                    </div>
                  </div>
                  <Button 
