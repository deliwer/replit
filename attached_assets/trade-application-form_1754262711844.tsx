          ...
          <CardContent className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Select onValueChange={(value) => handleInputChange("pickupLocation", value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Mazaya Center">Mazaya Center</SelectItem>
                      <SelectItem value="Airport Freezone">Airport Freezone</SelectItem>
              ...
              <div className="space-y-4">
                ...
                >
                  {mutation.isPending ? "Submitting..." : "Submit Trade-in Application"}
                </Button>
